...
public class OrderVM {
	private final static Logger logger = LoggerFactory.getLogger(OrderVM.class);
...
//		Executions.createComponents("customer.zul", displayPage, null);
	...
	public void fetchOrderDetails() {
		...
		BindUtils.postNotifyChange(null, null, OrderVM.this, "orderDetails");
		BindUtils.postNotifyChange(null, null, OrderVM.this, "order");
	}
...
//	@NotifyChange({"customers"})
	...
	public void add() {
		...
		BindUtils.postNotifyChange(null, null, OrderVM.this, "customers");
	}
